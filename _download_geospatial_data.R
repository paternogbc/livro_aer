...
## Baixas os dados
geo_dados_agua <- sidrar::get_sidra(x = 3218,
                                    variable = 1000096,
                                    period = "last",
                                    classific = c("c61"),
                                    geo = "City")

geo_dados_banheiro <- sidrar::get_sidra(x = 3218,
                                        variable = 1000096,
                                        period = "last",
                                        classific = c("c299"),
                                        geo = "City")

geo_dados_lixo  <- sidrar::get_sidra(x = 3218,
                                     variable = 1000096,
                                     period = "last",
                                     classific = c("c67"),
                                     geo = "City")

geo_dados_luz <- sidrar::get_sidra(x = 3218,
                                   variable = 1000096,
                                   period = "last",
                                   classific = c("c309"),
                                   geo = "City")
...
## Vetor
geo_vetor_brasil_municipios <- geobr::read_municipality(
