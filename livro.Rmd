...
-   A homegeneidade da variância utiliza um gráfico dos resíduos (eixo X) pelos valores preditos da variável resposta (eixo Y) (Figura \@ref(fig:fig-homo-norm)A). A distribuição dos resíduos será homogênea senão observarmos nenhum padrão na distribuição dos pontos (i.e. forma em V, U ou funil). 
-   A normalidade dos resíduos utiliza um gráfico de quantis-quantis (QQ-plots). A distribuição dos resíduos será normal se os pontos estiverem próximos à reta (Figura \@ref(fig:fig-homo-norm)B).
...
- [Análises de ordenação - 1] (https://www.davidzeleny.net/anadat-r/doku.php/en:ordination)
- [Análises de ordenação - 2](http://ordination.okstate.edu/overview.htm)
- [Classificação numérica - agrupamento e kmeans](https://www.davidzeleny.net/anadat-r/doku.php/en:classification)


## Exercícios


[Soluções dos exercícios](https://exercicios-livro-aer.netlify.app/cap.-9---introdu%C3%A7%C3%A3o-ao-r.html).
