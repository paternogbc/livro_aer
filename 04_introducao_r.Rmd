...
Essa estruturação irá nos contar sobre a organização dos elementos, com relação aos modos e dimensionalidade da disposição dos elementos (Figura \@ref(fig:fig-r-estruturas), adaptado de Grolemund [-@grolemund2014]). De modo bem simples, os elementos podem ser estruturados em cinco tipos:
...
```{r fig-r-estruturas, echo=FALSE, fig.cap="Estruturas de dados mais comuns no R: vetores, matrizes, arrays, listas e data frames."}
