...
Nesse exemplo vamos calcular a CWM e depois usar uma PERMANOVA (Capítulo \@ref(cap9)) para comparar o efeito da áreas com e sem pastejo sobre a diversidade funcional (Figura \@ref(fig:fig-func-cwm-model)).
