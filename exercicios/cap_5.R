...
# 2. -----
# 2. Use a função `download.file()` e `unzip()` para baixar e extrair o arquivo 
# do data paper de médios e grandes mamíferos: 
# [ATLANTIC MAMMALS](https://doi.org/10.1002/ecy.2785).
...
# 3. -----
# 3. Use a função `tibble::glimpse()` para ter uma noção geral dos dados 
...
# 4. -----
# 4. Compare os dados de penguins (*palmerpenguins::penguins_raw* e 
# *palmerpenguins::penguins*). Monte uma série de funções dos pacotes *tidyr* e 
# `dplyr` para limpar os dados e fazer com que o primeiro dado seja igual ao segundo.
...
# 5. -----
# 5. Usando os dados de penguins (*palmerpenguins::penguins*), calcule a 
# correlação de Pearson entre comprimento e profundidade do bico para cada espécie 
# e para todas as espécies. Compare os índices de correlação para exemplificar o Paradoxo de Simpsom.
...
# 6. -----
# 6. Oficialmente a pandemia de COVID-19 começou no Brasil com o primeiro caso 
