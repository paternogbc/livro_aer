...
::: {.alert .alert-info}
<strong> 📝 Importante: </strong> Neste caso, estamos realizando uma análise exploratória e não temos uma predição.
:::
