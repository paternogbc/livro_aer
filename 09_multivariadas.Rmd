...
A ordenação irrestrita ou análise de gradiente indireto, organiza os objetos de acordo 
...
## Gráficos
plot(simil.bocaina, simil.env)
plot(Dist.km, simil.env)
plot(log(Dist.km), log(1-simil.bocaina), 
