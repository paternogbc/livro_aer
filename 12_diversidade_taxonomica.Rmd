...
```{r fig-div-beta, fig.cap="Partição da diversidade beta taxonômica. Os três cenários apresentados representam a diversidade beta explicada somente por substituição, aninhamento e uma combinação dos dois.", echo=FALSE}
